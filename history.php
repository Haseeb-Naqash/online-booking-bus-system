...
<br><br>
						...
						<br>
									<table border="0"  align="center" class="table-tic">
									  <thead>
									      <tr><td colspan='11'><hr></td></tr>
										<tr class="tr2" height="80px">
											<th>#</th>
											<th>Name</th>
											<th>Email</th>
											<th>Phone Num</th>
											...
											if($result->num_rows > 0){
											  ...
											  for($x=0;$x<$num;$x++)
											  {
												   $encryption = openssl_encrypt($idH[$x], $ciphering,
													...
													<td align='center'>
													<br>
													<a class='viewbtn bt' href='view.php?id=$encrptID'>View</a>
													<br><br>
													<button class='upbtn bt'onclick='modal($x)'>Update</button>
													<br><br>
													<a class='delbtn bt' href='deleteTicket.php?id=$encrptID'>Delete</a>
													<br><br>
													</td>
