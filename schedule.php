...
<!--	<link rel="stylesheet" href="css/style.css">-->
   ...
   @media only screen and (max-width:700px) {
	...
	<div class="nav" style="background-color:#141850; text-align:center;" >
		<table class="nav-table"><tr style="color: #FFFFFF;" class="tr">
      <th><img src="nVehicle_logo.png" class="imgservice" width="100px" height="100px"/></th><th width="20px"></th><th  class="logotext">SinBus</th>
		<td width="90px">
			</td>
			...
			<h2 class="heading-section" style="color:white;">Where do you want to go from Sintok, Kedah?</h2>
				...
				<div class="row" align="center">
					   <form method="post" class="form">
						<input class="wd bookingdate" type="date" name="bookingdate" id="bookingdate" value="<?php echo $date ?>" required>
						<select class="des wd" id="destination" name="destination" required>
						...
						<button class="searchbtn wd" type="submit" name="filter">Search</button>
						 <button class="ResetBtn wd">Reset</button>
